...
async def test_get_books(db_session, async_client):
    ...
    book = books_sellers.Book(author="Pushkin", title="Eugeny Onegin", year=2001, count_pages=104)
    book_2 = books_sellers.Book(author="Lermontov", title="Mziri", year=1997, count_pages=104)
